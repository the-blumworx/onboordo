...
Read `.agents/AGENTS.md` for the full project rules and conventions. This file exists so Claude Code picks up the same instructions. The content below is intentionally identical.
